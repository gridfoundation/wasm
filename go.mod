...
require (
	...
	github.com/gridfoundation/cosmosclient v0.3.1-grid-rc0 // indirect
	github.com/gridfoundation/furyint v0.2.2-alpha // indirect
	github.com/gridfoundation/gridiron v0.2.0-gridiron // indirect
...
replace github.com/cosmos/cosmos-sdk => github.com/gridfoundation/rdk v0.1.1-RDK-gridiron
